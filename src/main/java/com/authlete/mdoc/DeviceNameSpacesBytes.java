...
/**
 * The {@code DeviceNameSpacesBytes} structure.
 *
 * <p>
 ...
 *
 * <pre>
 * DeviceNameSpacesBytes = #6.24(bstr .cbor {@link DeviceNameSpaces})
 * </pre>
 *
 * @since 1.5
 *
...
public class DeviceNameSpacesBytes extends CBORTaggedItem
{
    ...
    public DeviceNameSpacesBytes(DeviceNameSpaces deviceNameSpaces)
    {
        ...
        mDeviceNameSpaces = deviceNameSpaces;
    }


    public DeviceNameSpaces getDeviceNameSpaces()
    {
        return mDeviceNameSpaces;
    }
}
