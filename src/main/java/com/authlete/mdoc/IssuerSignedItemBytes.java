...
/**
 * The {@code IssuerSignedItemBytes} structure.
 *
 * <p>
 ...
 *
 * <pre>
 * IssuerSignedItemBytes = #6.24(bstr .cbor {@link IssuerSignedItem})
 * </pre>
 *
 * @since 1.5
 *
...
public class IssuerSignedItemBytes extends CBORTaggedItem
{
    ...
    public IssuerSignedItemBytes(IssuerSignedItem item)
    {
        super(24, new CBORByteArray(item.encode(), item));

        mIssuerSignedItem = item;
    }


    public IssuerSignedItem getIssuerSignedItem()
    {
        return mIssuerSignedItem;
    }
}
