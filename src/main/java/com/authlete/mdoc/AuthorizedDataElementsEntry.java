...
/**
 * An entry in the {@link AuthorizedDataElements} structure.
 *
 * <p>
...
{
    public AuthorizedDataElementsEntry(
            CBORString nameSpace, DataElementsArray dataElementsArray)
    {
        super(nameSpace, dataElementsArray);
    }


    public AuthorizedDataElementsEntry(
            String nameSpace, DataElementsArray dataElementsArray)
    {
        this(new CBORString(nameSpace), dataElementsArray);
    }
}
