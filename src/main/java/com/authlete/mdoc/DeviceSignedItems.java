...
/**
 * The {@code DeviceSignedItems} structure.
 *
 * <p>
 ...
 *
 * @see DeviceSignedItemsEntry
 */
public class DeviceSignedItems extends CBORPairList
{
    public DeviceSignedItems(List<? extends DeviceSignedItemsEntry> entries)
    {
        super(entries);
    }
}
